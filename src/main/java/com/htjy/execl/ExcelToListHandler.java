...
/**
 * Created by willz on 9/25/2017.
 */
public class ExcelToListHandler<T> {
    private String fileName;
    private JSONArray jsons;
    private Workbook workbook;

    public List<T> buildListByFileName(Class<T> clazz, String fileName) {
        return buildListByWorkbook(clazz, ExcelUtil.readExcelFile(fileName));
    }

    public List<T> buildListByWorkbook(Class<T> clazz, Workbook workbook) {
        try {
